...
namespace LazySquirrelLabs.TerracedTerrainGenerator.Editor
{
	...
	internal class SphereTerrainGeneratorControllerEditor : UnityEditor.Editor
	{
		#region Fields
		...
		private const string MaximumHeightHeightTooltip = "The maximum height of the generated terrain, in units.";
		...
		public override void OnInspectorGUI()
		{
			...
			DrawFloatSlider(_maximumHeight, MaximumHeightHeightTooltip, 0.1f, 100f);
